                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">First Year-2019</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS IT & EnTc</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Second Year-2020</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS IT & EnTc</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Third Year-2021</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS IT & EnTc</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">B.E-2022</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS IT & EnTc</h6>
